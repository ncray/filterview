...
/* Counsyl's addition to the jQuery.svg. This allows us to embed arbitrary
   HTML inside of an svg object. */
$.extend(SVGWrapper.prototype, {
        /* Insert a foreignObject.
           Specify x, y, width, and height.
           @param  parent    (element or jQuery) the parent node for the new shape (optional)
           @param  x         (number) the x-coordinate for the left edge of the foreignobject
           @param  y         (number) the y-coordinate for the top edge of the foreignobject
           @param  width     (number) the width of the foreignobject
           @param  height    (number) the height of the foreignobject
           @param  settings  (object) additional settings for the shape (optional)
           @return  (element) the new shape node */
        foreignObject: function(parent, x, y, width, height, settings) {
            var args = this._args(arguments, ['x', 'y', 'width', 'height']);
            return this._makeNode(args.parent, 'foreignObject', $.extend(
